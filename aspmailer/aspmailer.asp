...
<%
strRcpt = "sac@impactoconsultoriapvh.com.br" 'Put the address you want the form sent to here

strFromVar = "" 'If you want a reply-to email address to be taken from the form
' put the name of the input item here. 

strDefFrom = "sac@impactoconsultoriapvh.com.br" 'Put a default, even fake, From address here

strDefSubject = "Fale Conosco" 'Put the subject of the letter here. If an input item called
